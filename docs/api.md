...
Контракт нужен в MVP: админ заводит отделы и сотрудников и меняет cutoff/город с экрана, не только через seed. Seed по-прежнему создаёт три демо-учётки на этапе 0.
