...
Сделанную задачу отмечает сам автор: `[ ]` → `[x]` в этом файле, в том же коммите. Чужие пункты не закрывать. Правило — в [process.md](process.md).
...
- [x] **Сетка каталога, категории, поиск**
